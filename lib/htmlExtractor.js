...
export function extractStructuredDataFromHTML(html) {
  ...
  try {
    ...
    // 4. Location Address extraction - handle multiple formats
    ...
    // Format 2: "* Location: North Devon - Hartland Quay *" (asterisk-separated)
    ...
    // Format 3: "Location: North Devon - Hartland Quay" (inline)
    if (!extracted.location_address) {
    ...
    // 6. Fitness Level extraction - handle multiple formats
    ...
    // Format 2: "* Fitness: 2. Moderate *" (asterisk-separated)
    ...
    // Format 3: "Fitness: 2. Moderate" (inline)
    if (!extracted.fitness_level) {
