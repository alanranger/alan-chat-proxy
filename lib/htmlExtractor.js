  ...
  const lines = cleaned.split(/\r?\n/)
    ...
    .filter(line => {
      ...
      return !lowerLine.includes('alan ranger photography [//images.squarespace-cdn.com') &&
             ...
             // Additional Squarespace/navigation/script noise
             ...
             !lowerLine.includes('you will receive an email to verify') &&
             !lowerLine.includes('the legal stuff') &&
             !lowerLine.includes('lazy-summaries-admin') &&
             !lowerLine.includes('collections-index-sync') &&
             !lowerLine.includes('customfiltersettings') &&
             !lowerLine.includes('window.customregisterinterestsettings') &&
             !lowerLine.includes('window.collectionsyncconfig') &&
             !lowerLine.includes('sqs-admin-hooks') &&
             !lowerLine.includes('plugins.squarewebsites.org') &&
             !lowerLine.includes('assets.squarewebsites.org') &&
             !lowerLine.includes('document.addEventListener') &&
             !lowerLine.includes('document.querySelector') &&
             !lowerLine.includes('window.self') &&
             !lowerLine.includes('window.top') &&
             !lowerLine.includes('proud to be a member of') &&
