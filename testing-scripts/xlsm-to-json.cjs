// Minimal XLSM -> JSON exporter (CommonJS)
// Usage:
//   node testing-scripts/xlsm-to-json.cjs "testing-scripts/test results/xlsm/28 question routing path.xlsm"
...
function main() {
  ...
  if (!inputPath) {
    console.error('Usage: node testing-scripts/xlsm-to-json.cjs <path-to-xlsm>');
    process.exit(1);
  }
