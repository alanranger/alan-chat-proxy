// Apply the enhanced v_events_for_chat view migration
import fetch from 'node-fetch';

const API_URL = 'https://alan-chat-proxy.vercel.app/api/admin';
...
async function applySessionMigration() {
  console.log('🔄 Applying enhanced v_events_for_chat view migration...');
...
// Run the migration
applySessionMigration().catch(console.error);
