...
async function runQualityBenchmark() {
  ...
  const resultsFile = `testing-scripts/test results/quality-benchmark-before-${timestamp}.json`;
  ...
  const baselineFile = 'testing-scripts/test results/quality-benchmark-before-2025-10-22T17-04-41-287Z.json';
