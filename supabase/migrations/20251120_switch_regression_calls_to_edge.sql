-- Switch regression-test HTTP calls to Supabase Edge Function directly
-- Avoids dependency on admin ingest token and fixes 401 errors
...
DECLARE
  ...
  v_service_key TEXT;
BEGIN
  -- Resolve Supabase Edge base URL + service role key
  BEGIN
...
DECLARE
  v_result TEXT;
BEGIN
  v_result := light_refresh_batch_with_regression_test(p_batch, p_chain_next, false);
  RETURN v_result;
END;
$function$;
