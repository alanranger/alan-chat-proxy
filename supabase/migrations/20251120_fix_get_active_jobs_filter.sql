-- Fix get_active_jobs to exclude queries that are just calling the function itself
-- This prevents the active jobs banner from showing PostgREST wrapper queries
